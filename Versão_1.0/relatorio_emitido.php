<?php //INSERIR AQUI A CONEXÃO COM O BOTÃO "ENVIAR RELATÓRIO" E TAMBÉM UMA OPÇÃO DE BAIXAR O RELATÓRIO EM PDF
    
    include('relatorios.php');
    include('emitir_relatorio');
?>
                ...
                <tbody>
                    <?php 
                        if ($result_relatorio = mysqli_query($con, $consulta_relatorio))
                        {
                            ...
                            {
                                echo "<tr>"; 
                                echo "<td><input type='checkbox' name='tabela_relatorio[]' ></td>";
